...
namespace MikuMikuFlex3
{
    public class アニメ遷移_移動ベジェ : アニメ遷移<Vector3>
    {
        ...
        public override bool 更新する( double 現在時間sec, out Vector3 現在の値 )
        {
            ...
            現在の値 = new Vector3(
                this._開始値.X + ( this._終了値.X - this._開始値.X ) * Pyx,
                this._開始値.Y + ( this._終了値.Y - this._開始値.Y ) * Pyy,
                this._開始値.Z + ( this._終了値.Z - this._開始値.Z ) * Pyz );
